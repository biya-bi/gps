...
from pip.products import distutils_scheme, PIP_DELETE_MARKER_FILENAME
...
def _cache_for_link(cache_dir, link):
    ...
    # Inside of the base product for cached wheels, expand our parts and join
    # them all together.
...
def uninstallation_paths(dist):
    ...
    for row in r:
        path = os.path.join(dist.product, row[0])
        yield path
        if path.endswith('.py'):
            ...
            for req in buildset:
                ...
                if wheel_file:
                    ...
                    if autobuilding:
                        ...
                        req.source_dir = req.build_product(
